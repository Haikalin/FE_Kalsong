    ...
    return (
        ...
        <div className="w-5/6 mx-auto text-xs sm:text-base lg:w-5/12 mx-auto lg:text-base md:w-3/4 md:text-base">
            <table id="tabelmusik" className="w-full font-Inter mt-5 border border-black-700 table-fixed">
                <thead>
                    <tr>
                        <th className="bg-second-two border border-black text-white px-4 py-2 w-2/12 lg:w-1/12 font-Roboto font-bold">No</th>
                        <th className="bg-second-two border border-black text-white px-12 py-2 w-6/12 lg:w-7/12 font-Roboto font-bold" >Judul Lagu</th>
                        <th className="bg-second-two border border-black text-white px-4 py-2 w-4/12 font-Roboto font-bold">Artis</th>
                    </tr>
                </thead>
