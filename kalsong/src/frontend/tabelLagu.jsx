...
export const TabelLagu = ({data, num}) => {
    ...
    return (
        console.log(data),
        <div className="w-5/6 h-96 min-h-96 lg:h-100 lg:min-h-100 mx-auto text-xs sm:text-base lg:w-5/12 mx-auto lg:text-base md:w-3/4 md:text-base">
            <table id="tabelmusik" className="w-full mt-5 border border-black-700 table-fixed">
                <thead>
                    <tr>
                        <th className="bg-second-two border border-black text-white px-4 py-2 w-2/12 lg:w-1/12 font-bold">No</th>
                        <th className="bg-second-two border border-black text-white px-12 py-2 w-6/12 lg:w-7/12 font-bold" >Judul Lagu</th>
                        <th className="bg-second-two border border-black text-white px-4 py-2 w-4/12 font-bold">Artis</th>
                    </tr>
                </thead>
